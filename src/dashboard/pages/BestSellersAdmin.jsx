  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Best Sellers Overview</h1>
          <p className="text-slate-500 mt-1">Trips currently displayed in the "Best Sellers" section on the homepage.</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-slate-50 border border-slate-200 border-dashed rounded-3xl p-12 text-center">
          <p className="text-slate-500 mb-4">No trips are currently marked as Best Sellers.</p>
